                ...
                case 3:
                    {
                        ...
                        uiWangTongTiaoMove.GetComponent<Image>().DOFade(0, 1f);

                        uiWangTongTiaoFlagImage.color = new Color(1, 1, 1, 0);
                        uiWangTongTiaoFlagImage.DOFade(1, 0.4f);
                ...
                case 5:
                    {
                        ...
                        wangTongTiao[(int)clickHuaSe].GetComponent<Image>().DOFade(0, 0.4f);
                        SetState(11, 0);
                    }
                    break;
