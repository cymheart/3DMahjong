...
namespace MahjongMachineNS
{
    public class UIHuPaiTips
    {
        ...
        public void Setting(MahjongMachine mjMachine)
        {
            ...
            prefabUiHuPaiTips = mjAssets.uiPrefabDict[(int)PrefabIdx.UI_HUPAI_TIPS][0];
            ...
            prefabUiHuPaiDetailTips = mjAssets.uiPrefabDict[(int)PrefabIdx.UI_HUPAI_DETAIL_TIPS][0];
