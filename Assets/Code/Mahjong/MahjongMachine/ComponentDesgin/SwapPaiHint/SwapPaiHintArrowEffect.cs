...
{
    public class SwapPaiHintArrowEffect: MahjongMachineComponent
    {
        ...
        public void Setting(MahjongMachine mjMachine)
        {
            ...
            prefabSwapPaiHintOppositeArrow = mjAssetsMgr.effectPrefabDict[(int)PrefabIdx.SWAPPAI_TIPS_OPP_ARROW][0];
            prefabSwapPaiHintClockWiseArrow = mjAssetsMgr.effectPrefabDict[(int)PrefabIdx.SWAPPAI_TIPS_CLOCKWISE_ARROW][0];
            prefabSwapPaiHintAntiClockWiseArrow = mjAssetsMgr.effectPrefabDict[(int)PrefabIdx.SWAPPAI_TIPS_ANTICLOCKWISE_ARROW][0];
        }
